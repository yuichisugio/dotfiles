...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/yuichi.sugio/.nvm/versions/node/v20.18.1/lib/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH='/Users/yuichi.sugio/.npm-global/bin:/Users/sugioyuuichi/opt/anaconda3/bin:/Users/sugioyuuichi/Library/pnpm:/Users/yuichi.sugio/Library/pnpm:/usr/local/node20-arm64/bin:/Users/yuichi.sugio/.nvm/versions/node/v20.18.1/bin:/opt/homebrew/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin'
